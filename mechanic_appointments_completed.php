    ...
    <div class="container mt-4">
        ...
        <div class="row mt-4 mb-3">
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <a class="nav-link px-5" aria-current="page" href="./mechanic_appointments_upcoming.php">Upcoming</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link px-5" href="./mechanic_appointments_pending.php">Pending</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active px-5" href="./mechanic_appointments_completed.php">Completed</a>
                </li>
            </ul>
        </div>
        <!-- Car Detail Cards -->
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <div class="row text-end">
                                ...
                                <div class="col-2">
                                    <button type="button" class="btn p btn-primary" onclick="window.location='./mechanic_appointment_details_completed.php';">View <span><i class="fa-solid fa-arrow-right"></i></span></button>
                                </div>
                            </div>
                        </div>
