                ...
                <div class="card-body">
                    ...
                    <div class="row mt-4 mb-3">
                        <ul class="nav nav-tabs">
                            <li class="nav-item">
                                <a class="nav-link active px-5" aria-current="page" href="./seller_profile.php">Info</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link px-5" href="./seller_profile_cars.php">Cars</a>
                            </li>
                        </ul>
                    </div>
                    <div class="row my-3 text-center">
                        <div class="col">
                            <div class="row text-start ms-5 mt-4">
                                ...
                                <h5 class="">Joined On</h5>
                                <p class="fs-5">June 13th, 2022</p>
                            </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <button type="button" class="btn p btn-primary" onclick="window.location='./vehicle-details.php';">Back</button>
                        </div>
