                    ...
                    <div class="navbar-nav ms-auto">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a class="dropdown-item" href="./buyer_account_edit.php?logout='1'">Logout</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container mt-4" style="width: 500px;">
        ...
        <div class="mx-auto">
            ...
            <div class="row text-center my-4">
                <div class="col">
                    <button type="button" class="btn btn-primary px-5" onclick="window.location='./buyer_account.php';">Cancel</button>
                </div>
                <div class="col">
