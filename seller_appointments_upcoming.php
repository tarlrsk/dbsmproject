    ...
    <div class="container mt-4">
        ...
        <div class="row mt-4 mb-3">
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <a class="nav-link active px-5" aria-current="page" href="./seller_appointments_upcoming.php">Upcoming</a>
                </li>
                <li class="nav-item">
        ...
        $select_stmt = $db->prepare("SELECT * FROM appoint_tb
                                    ...
                                    WHERE appoint_tb.seller_id = '$seller_id'
                                    AND seller_status = '1'
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <div class="row text-end">
                                    ...
                                    <div class="col-2">
                                        <button type="button" class="btn p btn-primary" onclick="window.location='./appointment_details.php?appoint_id=<?php echo $row['appoint_id'] ?>';">View <span><i class="fa-solid fa-arrow-right"></i></span></button>
                                    </div>
                                </div>
                            </div>
