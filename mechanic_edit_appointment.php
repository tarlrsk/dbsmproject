...
<body>
    ...
    <div class="container mt-4">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="row my-3">
                            <div class="col text-center">
                                <h6>Current Appointment Date</h6>
                            ...
                            <div class="col text-center">
                                <h6>Current Consulting Price</h6>
                                <p>1,000 THB</p>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col text-center">
                                <label for="appointment_date" class="form-label">Select New Appointment Date</label>
                                <input type="date" oninput="this.className = ''" placeholder="Select Appointment Date" name="appointment_date">
                            </div>
                            <div class="col text-center">
                                <label for="appointment_time" class="form-label">Select New Appointment Time</label>
                                <input type="time" oninput="this.className = ''" placeholder="Select Appointment Time" name="appointment_time">
                            </div>
                            <div class="col text-center">
                                <label for="consulting_price" class="form-label">New Consulting Price</label>
                                <input type="number" oninput="this.className = ''" placeholder="1,000" name="appointment_time">
                                <label for="">THB</label>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row my-5" style="width: 750px;">
            <div class="col">
                <button type="button" class="btn btn-primary" onclick="window.location='./mechanic_appointment_detail.php';">Back</button>
            </div>
