                    ...
                    <div class="navbar-nav ms-auto">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <a class="dropdown-item" href="./mechanic_account.php">Account</a>
    ...
    <div class="container mt-4">
        ...
        <div class="row mt-4 mb-3">
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <a class="nav-link active px-5" aria-current="page" href="./mechanic_appointments_upcoming.php">Upcoming</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link px-5" href="./mechanic_appointments_pending.php">Pending</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link px-5" href="./mechanic_appointments_completed.php">Completed</a>
                </li>
            </ul>
        </div>
        <!-- Car Detail Cards -->
        ...
        $select_stmt = $db->prepare("SELECT * FROM appoint_tb
                                    ...
                                    WHERE appoint_tb.mechanic_id = '$mechanic_id'
                                    AND mechanic_status = '1'
                    ...
                    <div class="card-body">
                        <div class="row my-3 text-center">
                            ...
                            <div class="col">
                                ...
                                <p class="fs-5"><?php echo $row['buyer_name']?></>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <div class="row text-end">
                                    ...
                                    <div class="col-2">
                                        <button type="button" class="btn p btn-primary" onclick="window.location='./mechanic_appointment_details_upcoming.php?appoint_id=<?php echo $row['appoint_id']?>';">View <span><i class="fa-solid fa-arrow-right"></i></span></button>
                                    </div>
                                </div>
                            </div>
