    ...
    <div class="container mt-4" style="width: 500px;">
        ...
        <div class="mx-auto">
            ...
            <div class="row text-center my-4">
                <div class="col">
                    <button type="button" class="btn btn-primary px-5" onclick="window.location='./seller_appointments_upcoming.php';">Cancel</button>
                </div>
                <div class="col">
                    <button type="button" class="btn btn-primary px-5" onclick="window.location='./seller_account_edit.php';">Edit</button>
                </div>
