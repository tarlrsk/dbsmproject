...
<body>
                    ...
                    <div class="navbar-nav ms-auto">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a class="dropdown-item" href="./mechanic_appointment_detail.php?logout='1'">Logout</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container mt-4">
        ...
        <div class="row my-5" style="width: 750px;">
            <div class="col">
                <button type="button" class="btn btn-primary" onclick="window.location='./mechanic_manage_appointment.php';">Back</button>
            </div>
            <div class="col text-end">
                <button type="button" class="btn btn-primary" onclick="window.location='./mechanic_edit_appointment.php';">Edit</button>
            </div>
        </div>
    </div>
