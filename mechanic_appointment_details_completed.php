                    ...
                    <div class="navbar-nav ms-auto">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a class="dropdown-item" href="./mechanic_appointment_details_completed.php?logout='1'">Logout</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row my-3">
            <div class="card" style="width: 60rem;">
                <div class="card-body">
                    <div class="row my-3 text-center">
                        <div class="col">
                            ...
                            <div class="row text-start ms-5 mt-4">
                                ...
                                <h5 class="">Appointmenet Date</h5>
                                <p class="fs-5">September 15, 2022</p>
                                <h5 class="">Appointmenet Time</h5>
                                <p class="fs-5">11:00 AM</p>
                                <h5 class="">Appointmenet Review</h5>
                                <div class="row">
                                    <div class="">
                                ...
                                <p>He is good at checking the vechicle condition and give great advice on helping me
                                    deciding whether to buy the car or not.</p>
                                <div>
                                    <h6>Reviewed On: Sep 18th, 2022</h6>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <button type="button" class="btn p btn-primary" onclick="window.location='./mechanic_appointments_completed.php';">Back</button>
                        </div>
