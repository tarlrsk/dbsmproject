...
if (isset($_GET['completed'])) {
    $update_appoint = "UPDATE appoint_tb SET buyer_status = '0' WHERE appoint_tb.appoint_id = '$appoint_id'"; //set
    mysqli_query($conn, $update_appoint);
    header('location: buyer_appointments_upcoming.php');
}
...
<body>
            ...
            <div class="container-fluid mx-5">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav">
                        ...
                        <a class="nav-link nav-active-border" href="./buyer_appointments_upcoming.php">My
                            Appointments</a>
                    </div>
                    <div class="navbar-nav ms-auto">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a class="dropdown-item" href="./buyer_appointment_details_upcoming.php?logout='1'">Logout</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container mt-4">
        ...
        $select_stmt = $db->prepare("SELECT * FROM appoint_tb
                                    ...
                                    INNER JOIN mechanic_tb
                                    ON appoint_tb.mechanic_id = mechanic_tb.mechanic_id
            ...
            <div class="row my-3">
                <div class="card" style="width: 60rem;">
                    <div class="card-body">
                            ...
                            <div class="col">
                                ...
                                <div class="row my-3">
                                    ...
                                    <div class="col text-start px-0">
                                        <h4 class="mt-2"><?php echo $row['mechanic_name'] ?></h4>
                                ...
                                <div class="row text-start ms-5 mt-4">
                                    ...
                                    <p class="fs-5"><?php echo $row['mechanic_phone'] ?></p>
                                    <h5 class="">Email Address</h5>
                                    <p class="fs-5"><?php echo $row['mechanic_email'] ?></p>
                                    <h5 class="">Consulting Fee</h5>
                        ...
                        <div class="row">
                            <div class="col">
                                <button type="button" class="btn p btn-primary" onclick="window.location='./buyer_appointments_upcoming.php';">Back</button>

                            </div>
                            <div class="col-2 text-end">
                                <button type="button" class="btn p btn-primary" onclick="window.location='./buyer_appointment_details_upcoming.php?completed=1&appoint_id=<?php echo $appoint_id ?>'">Completed</button>
                            </div>
                        </div>
